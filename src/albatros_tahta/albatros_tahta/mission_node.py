...
class MissionNode(Node):
    ...
    def __init__(self):
        ...
        self.parkur3_substate = "SCAN"  # "SCAN", "APPROACH", "TOUCH"

        # Parkur 3 Target Validation Feedback
    ...
    def parkur3_target_callback(self, msg: String):
        """Processes feedback from parkur3_target_node."""
        try:
    ...
    def main_loop(self):
        ...
        # Parkur 3 Sub-state Machine & Scan Wiper Motion Logic
    ...
    def process_parkur3_substates(self):
        """Manages Parkur 3 sub-states: SCAN, APPROACH, TOUCH."""
        now = time.monotonic()
        ...
        if self.parkur3_substate == "SCAN":
            ...
            # Check if target is confirmed by parkur3_target_node
            ...
            if yaw_error <= self.yaw_tolerance_deg:
                if self.scan_settle_start_time is None:
                    ...
                    # Settle pause finished -> advance to next scan angle in sequence
            ...
            # Target bearing points toward confirmed target angle
